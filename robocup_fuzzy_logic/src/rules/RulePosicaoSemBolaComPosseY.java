...
public class RulePosicaoSemBolaComPosseY {
	private FuzzyVariable posicao;
	private FuzzyRule[] rules;
	private FuzzyValue[] inputsFuzzy;

	public RulePosicaoSemBolaComPosseY(double a, double b, double c, double d, double e) throws Exception {
		// Step 1 (define the FuzzyVariables for posicao)

		// Variavel Posicao
		posicao = new FuzzyVariable("distancia", a, e, "metros");
		posicao.addTerm("mtoEsquerda", new TriangleFuzzySet(a, a, b));
		...
		posicao.addTerm("mtoDireita", new TriangleFuzzySet(d, e, e));
	...
	public void defineRules() throws Exception {
		...
		rules[1].addConclusion(new FuzzyValue(posicao, "mtoEsquerda"));
		...
		rules[2].addConclusion(new FuzzyValue(posicao, "mtoEsquerda"));
		...
		rules[4].addConclusion(new FuzzyValue(posicao, "esquerda"));
		...
		rules[5].addConclusion(new FuzzyValue(posicao, "esquerda"));
		...
		rules[7].addConclusion(new FuzzyValue(posicao, "esquerda"));
		...
		rules[11].addConclusion(new FuzzyValue(posicao, "centro"));
		...
		rules[13].addConclusion(new FuzzyValue(posicao, "centro"));
		...
		rules[17].addConclusion(new FuzzyValue(posicao, "direita"));
		...
		rules[19].addConclusion(new FuzzyValue(posicao, "direita"));
		...
		rules[20].addConclusion(new FuzzyValue(posicao, "direita"));
		...
		rules[22].addConclusion(new FuzzyValue(posicao, "mtoDireita"));
		...
		rules[23].addConclusion(new FuzzyValue(posicao, "mtoDireita"));
